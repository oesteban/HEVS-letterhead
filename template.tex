...
\DefineLocalizedString{EndorsementLabel}
...
\newcommand{\LetterRecipientEmailValue}{}
\newcommand{\LetterRecipientEmail}[1]{\renewcommand{\LetterRecipientEmailValue}{#1}}
...
\newcommand{\LetterEndorserValue}{}
\newcommand{\LetterEndorser}[1]{\renewcommand{\LetterEndorserValue}{#1}}
...
\providecommand{\DTMifdatestyle}[3]{%
  \@ifundefined{DTMdatestyle@#1}{#3}{#2}%
}
\makeatother
...
\EndorsementLabel[en]{Approved and endorsed by:}
\EndorsementLabel[fr]{Approuv\'e et valid\'e par :}
...
\LetterRecipientEmail{\href{mailto:<EMAIL>}{<EMAIL>}}
...
% \LetterEndorser{Dr. Alex Supervisor}
...
\ifstrempty{\LetterRecipientEmailValue}{}{\LetterRecipientEmailValue}
\end{adjustwidth}
...
% To include a signature, place signature.png and set \showsignaturetrue; CI builds run without a signature file.
\newif\ifshowsignature
\showsignaturefalse

\ifstrempty{\LetterEndorserValue}{%
  \ifshowsignature
    \IfFileExists{signature.png}{\includegraphics[width=2.5cm]{signature.png} \\}{}
  \fi
  ...
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}ll}
    ...
    &
    \begin{minipage}[t]{0.45\textwidth}
      \IfLocalizedStringDefined{EndorsementLabel}{\EndorsementLabel \\}{}
      \LetterEndorserValue
    \end{minipage}
  \end{tabular*}
}
